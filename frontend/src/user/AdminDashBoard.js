...
const AdminDashBoard = () => {
    ...
    const adminRightSide = ()=>{
        return(
            <div className="card mb-4">
                ...
                <ul className="list-group">
                 <li className="list-group-item">
                     <span className="badge badge-success mr-2 text-warning">Name :</span>{name}
                 </li>
                 <li className="list-group-item">
                     <span className="badge badge-success mr-2 text-warning">Email :</span>{email}
                 </li>
                 <li className="list-group-item">
                     <span className="badge badge-success text-warning "> admin area</span>
                 </li>
               </ul>
            </div>
        )
    ...
    return (
        <Base title="Welcome Admin" description="Manage all  of your products here"  className="conatiner bg-success p-4" >
             <div className="row" >  
               <div className="col-3">
                        {adminLeftSide()}
               </div>
